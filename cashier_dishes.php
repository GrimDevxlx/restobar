    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="cashier_menu.php"> <img class="img-rounded" src="images/logo.png" alt="" width="18%"> </a>
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item"> <a class="nav-link active" href="cashier_menu.php">Home <span class="sr-only">(current)</span></a> </li>                     
                        <?php
        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="cashier_dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite food</a></li>
...
?>
                                ...
                                <div class="title-row">
                                    <?php echo $item["title"]; ?><a href="cashier_dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>">
...
?>
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <a href="cashier_checkout.php" class="btn btn-danger btn-lg disabled">Checkout</a>

                                <?php
                                        }
                                        else{   
                                        ?>
                                <a href="cashier_checkout.php" class="btn btn-success btn-lg active">Checkout</a>
                                <?php   
                                        }
                                        ?>
                            ...
                            <div class="food-item">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-lg-8">
                                        <form method="post" action='cashier_dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
