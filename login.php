...
<body>
    ...
    <div style=" background-image: url('images/img/login.png');">
...
if(isset($_POST['submit']))  
{
	...
	if(!empty($_POST["submit"]))   
     {
	$sql ="SELECT * FROM user WHERE username='".$username."' AND password='".$password."'"; //selecting matching records
	$result=mysqli_query($db, $sql); //executing
	$row=mysqli_fetch_array($result);
	                        ...
	                        if($row["usertype"]=="user") 
								...
								{
                                    	$_SESSION["user_id"] = $row['u_id']; 
										 header("refresh:1;url=cashier_menu.php"); 
	                            } 
