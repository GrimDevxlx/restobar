...
{	
		...
		if(empty($_POST['d_name'])||empty($_POST['about'])||$_POST['price']==''||$_POST['stocks']==''||$_POST['res_name']=='')
		{	
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO dishes(rs_id,title,slogan,price,stocks,img) VALUE('".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$_POST['stocks']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
                                                    ...
                                                    <div class="row p-t-20">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="stocks" class="form" placeholder="0">
                                                            </div>
                                                        </div>
