                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                             ...
                                             <?php
												$sql="SELECT * FROM employees order by em_id desc";
																					...
																					echo ' <tr><td>'.$rows['f_name'].'</td>
                                                                                                ...
                                                                                                <td>'.$rows['position'].'</td>                  
                                                                                                 <td>'.$rows['resume'].'</td> 
																									 ...
																									 <td><a href="delete_employee.php?emp_del='.$rows['em_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_employee.php?emp_upd='.$rows['em_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
																		}	
														}
											?>
