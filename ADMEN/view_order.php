                                            ...
                                            <div class="card card-outline-primary">
                                                ...
                                                <div class="table-responsive m-t-20">
                                                    <table id="myTable" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            <?php
											$sql="SELECT user.*, users_orders.* FROM user INNER JOIN users_orders ON user.u_id=users_orders.u_id where o_id='".$_GET['user_upd']."'";
												...
												?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <a  onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php 
																			 ...
																			 { ?>
                                                                <td>
                                                                    <center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span>In process</button></center>
                                                                </td>
                                                                <?php 
																			  }
