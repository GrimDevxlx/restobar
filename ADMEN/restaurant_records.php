                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            while($row=mysqli_fetch_array($query_res))
                                            {
                                                ...
                                                <td data-column="Action"> <a href="record_delete.php?order_del=<?php echo $row['c_id'];?>" onclick="return confirm('Are you sure you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                                                </td>
